    ...
    <div class="grid-container">
        ...
        <main class="main-container">
            <div class="main-title">
                <p class="font-weight-bold">Applicant Archive</p>
            </div>

            <div class="archive-list">
                <!-- Sample Archived Applicant Cards -->
                <div class="archive-card">
                    <p class="applicant-name">John Doe</p>
                    <span class="applicant-details">Position: Developer</span>
                    <span class="applicant-details">Archived on: 01/10/2023</span>
                    <a href="/applicant">
                ...
                <div class="archive-card">
                    <p class="applicant-name">Jane Smith</p>
                    <span class="applicant-details">Position: Designer</span>
                    <span class="applicant-details">Archived on: 01/11/2023</span>
                    <a href="/applicant">
                        <button class="restore-button">Restore</button>
                        </a>
                </div>
                ...
                <div class="archive-card">
                    <p class="applicant-name">Sam Wilson</p>
                    <span class="applicant-details">Position: Product Manager</span>
                    <span class="applicant-details">Archived on: 01/12/2023</span>
                    <a href="/applicant">
                        <button class="restore-button">Restore</button>
                        </a>
                </div>
